      ...
      if (isSignUp) {
        ...
        if (error) {
          ...
          toast({
            ...
            description: 'Welcome to VerifyID.',
          });
          navigate('/dashboard');
        }
      } else {
      ...
      <div className={`auth-wrapper ${isSignUp ? 'toggled' : ''}`}>
        ...
        <div className="credentials-panel signin">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="slide-element pt-2 pb-2 text-center text-xs text-muted-foreground">
              ...
              <div className="flex gap-2 justify-center mt-2">
                <button
                  ...
                  className="px-3 py-1.5 rounded border border-border bg-secondary/50 hover:bg-secondary text-xs flex items-center gap-1.5"
                >
                  Google
                </button>
                <button
